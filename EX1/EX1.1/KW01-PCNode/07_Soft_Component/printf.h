...
#define va_start1 _crt_va_start
#define va_arg1 _crt_va_arg
#define va_end1 _crt_va_end
...
//初始定位变参数函数指针位置
#define _crt_va_start(ap,v) ( ap = (va_list1)&(v) + _INTSIZEOF(v) )
//依次读取变参数的数值
#define _crt_va_arg(ap,t)   ( *(t *)((ap+=_INTSIZEOF(t)),ap-_INTSIZEOF(t)) )
//放空ap指针为下一次调用做准备
#define _crt_va_end(ap)     ( ap = (va_list1)0 )
